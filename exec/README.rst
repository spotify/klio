...
As the ``klio-exec`` package is not meant to be installed directly, check out the `installation guide <https://spotify-klio-klio.readthedocs-hosted.com/en/latest/quickstart/installation.html>`_ for how to setup installation.
There is also the `user guide <https://spotify-klio-klio.readthedocs-hosted.com/en/latest/userguide/index.html>`_ and the `API documentation <https://spotify-klio-klio.readthedocs-hosted.com/en/latest/reference/executor/api.html>`_ for more information.
