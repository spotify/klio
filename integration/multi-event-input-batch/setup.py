...
setuptools.setup(
    name="multi-event-input-batch",  # required
    version="0.0.1",  # required
    author="The klio devs",  # optional
    author_email="opensource+klio@spotify.com",  # optional
    description="Integration Test - Multi Event Input Batch",  # optional
    url="https://github.com/spotify/klio",  # optional
