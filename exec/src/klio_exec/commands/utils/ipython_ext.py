...
c.InteractiveShellApp.extensions = [
    "autoreload",
    "klio_exec.commands.utils.ipython_ext", 
]
...
class IPythonKlioMagic(magic.Magics):
    ...
    def _show_graph(self, pipeline):
        """Print a graphviz representation of a given pipeline.

        Args:
            pipeline (apache_beam.Pipeline): pipeline to generate graph.
        """
    ...
    def _show_info(self):
        """Print current job context and information about notebook environment.
        """
        # TODO: update header examples to look like Jupyter prompt instead of k>>
        print(ic.NOTEBOOK_SHOW_INFO_BANNER.format(**self.ctx_mgr._get_version_ctx_args()))
    ...
    def _show_notebook_intro(self):
        print(ic.NOTEBOOK_SHOW_INFO_INTRO)
